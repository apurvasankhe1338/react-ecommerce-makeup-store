  ...
  return (
    <div>
      <div className="categoryHold flex flex-col gap-14 font-normal absolute left-16 top-11">
        <div
          className="bodyHold lineHeight w-56 w56rem"
      ...
      {show && (
        <div
          className=" z-50 bodyContent color text-base"
      ...
      {show2 && (
        <div
          className=" z-50 hairContent flex flex-col"
          onMouseLeave={dontShowHandler}
        >
          ...
          <div className="hairTextHold flex flex-row relative font-semibold">
            <p className="flex flex-row flex-wrap w-56">
      ...
      {show4 && (
        <div
          className="newContent relative left-72 text-base text-gray-500 top-16"
          onMouseLeave={dontShowHandler}
        >
